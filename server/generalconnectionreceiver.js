...
const GameConnectionHandler = require('./handler/gameconnectionhandler');
//const LobbyConnectionHandler = require('./lobbyconnectionhandler');

//const ChatModule = require('./servermodules/chatmodule');
//const LobbyOnlineUserModule = require('./servermodules/lobbyonlineusermodule');

//const Redis = require("redis");
//const DBs = require('./distributed/db.json');

//const pubSubFactory = require("mq-pubsub").default;


/**
 * used to receive all socketio connections and routs them to the corresponding
 * servers
 */
class GeneralConnectionReceiver {

    constructor() {
        this.minigolfNsp = null;
       // this.lobbyNsp = null;
    ...
    start(io, options) {
        ...
        this.minigolfNsp = this.io.of(Packages.NAMESPACES.MINIGOLF);
      ...
      /*  if(options.sessionMiddleware) {
        ...
        this.gameConnectionHandler = new GameConnectionHandler(this.minigolfNsp);
...
module.exports = GeneralConnectionReceiver;